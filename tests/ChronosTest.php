...
class ChronosTest extends SapphireTest
{
     ...
     */
    public function getConfigFiles($identifier = null)
    {
        if ($identifier == "*") {
            $pattern = "*";
        } elseif ($identifier) {
    ...
    public function testAddItemsUnGrouped()
    {
    ...
    public function testAddItemsGrouped()
    {
    }

    public function testInvalidRemoved()
    {
    ...
    public function testNonRecurringExecution()
    {
     ...
     * @return void
     */
    public function testRecurringExecution()
    {
    ...
    public static function staticTestMethod($params)
    {
        $id = $params->id;
        $filename = TEMP_FOLDER . "/chronos_test_" . $id;
     ...
     */
    public function runScheduledExecutor($timeLimit = 5, $async = false)
    {
